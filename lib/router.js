...
router.get('/archive', (req, res) => {
  ...
  req.app.locals.conn.query(query, queryParams, (err, results) => {
    req.app.locals.conn.query("SELECT FOUND_ROWS() as total;", (err, total) => {
...
router.delete('/archive/:id', (req, res) => {
  ...
  req.app.locals.conn.query(query, [id], (err, results) => {
    if (err) {
